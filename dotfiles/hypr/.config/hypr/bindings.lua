...
-- Cycle the workspace through master, dwindle and scrolling instead of
-- Omarchy's dwindle/scrolling toggle. Unbind and bind rather than o.rebind,
-- which Omarchy 4.0.4 doesn't have yet.
hl.unbind("SUPER + L")
o.bind("SUPER + L", "Cycle workspace layout", "hypr-workspace-layout-cycle")
