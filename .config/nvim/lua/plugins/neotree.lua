  ...
  -- modern NERDTree
  {
    ...
    config = function()
      require('neo-tree').setup({
        ...
        nesting_rules = {},
        filesystem = {
          bind_to_cwd = true, -- bind the root directory to the current working directory
          filtered_items = {
          ...
          commands = {
            open_and_keep_focus = function(state)
              -- TODO MAKE THIS WORK
            end
      ...
      -- configure which-key bindings to open neotree to <leader>dd
      ...
      wk.add({
        ...
        { '<leader>dc', ':Neotree dir=./<cr>',                    desc = 'Change root to cwd' },
      })
    end
  }
}
