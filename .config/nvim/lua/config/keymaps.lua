...
map("n", "<leader>ut", function()
  -- Check the current colorscheme name
  local current_theme = vim.g.colors_name

  if current_theme == "vscode" then
...
--
-- -- lua
-- map({"n", "x"}, "<localleader>r", function() Snacks.debug.run() end, { desc = "Run Lua", ft = "lua" })map = true, silent = true })
