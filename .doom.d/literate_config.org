...
(use-package! org-gcal
  ...
  (setq
   ...
   org-gcal-client-secret (s-trim (get-string-from-file "~/org/gmail_calendars/gcal_client_secret"))
   org-gcal-fetch-file-alist '(("brandonpollack23@gmail.com" . "~/org/gmail_calendars/personal.org")
                               ...
                               ("dnu3qs4g5pp6h4m9rfhsppgbik@group.calendar.google.com" . "~/org/gmail_calendars/study.org"))))
#+end_src
